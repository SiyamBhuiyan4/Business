...
Open `http://localhost:3000/login` for the Super Admin interface, or `http://localhost:3000/admin/login` for the limited Admin interface.

Seeded accounts:

- Super Admin: `myempire.rise` / `Siy@m@123`
- Sample Admin: `mushroom.admin@example.com` / `Admin@123`
